...
namespace ResultOf.Tests
{
    class ResultAndUnitTests
    {
        ...
        public void AndOperator_failAndSuccess()
        {
            ...
            Assert.IsFalse(ReferenceEquals(result, _success1));
            Assert.IsTrue(ReferenceEquals(result, _fail1));
        ...
        public void AndOperator_successAndSuccess()
        {
            ...
            Assert.IsFalse(ReferenceEquals(result, _success1));
            Assert.IsTrue(ReferenceEquals(result, _success2));
        ...
        public void AndOperator_successAndSuccessAndSuccess()
        {
            ...
            Assert.IsFalse(ReferenceEquals(result, _success1));
            Assert.IsFalse(ReferenceEquals(result, _success2));
            Assert.IsTrue(ReferenceEquals(result, _success3));
            Assert.IsTrue(result.Succeeded);
        }
